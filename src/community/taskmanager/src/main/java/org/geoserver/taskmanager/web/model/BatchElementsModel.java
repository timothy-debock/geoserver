...
public class BatchElementsModel extends GeoServerDataProvider<BatchElement> {
    ...
    public static final Property<BatchElement> NAME = new BeanProperty<BatchElement>("name",
            "task.fullName");

    public static final Property<BatchElement> TYPE = new BeanProperty<BatchElement>("type",
            "task.type");
