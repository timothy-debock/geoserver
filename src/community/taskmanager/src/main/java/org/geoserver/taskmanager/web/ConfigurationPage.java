...
public class ConfigurationPage extends GeoServerSecuredPage {
    ...
    public void onInitialize() {
        ...
        form.add(new TextField<String>("name",
                new PropertyModel<String>(configurationModel, "name")) {
        ...
        if (configurationModel.getObject().getId() != null && !TaskManagerBeans.get().getSecUtil()
                .isWritable(getSession().getAuthentication(), configurationModel.getObject())) {
    ...
    protected String getDescription() {
        return new ParamResourceModel(
                configurationModel.getObject().isTemplate() ? "temp.description" : "description",
                this).getString();
    }
            ...
            public void onSubmit(AjaxRequestTarget target, Form<?> form) {
                ...
                dialog.showOkCancel(target, new GeoServerDialog.DialogDelegate() {
                    ...
                    protected boolean onSubmit(AjaxRequestTarget target, Component contents) {
                        if (configurationModel.getObject().getTasks()
                                .get(panel.getNameField().getModelObject()) != null) {
                            ...
                            TaskManagerBeans.get().getDataUtil()
                                    .addTaskToConfiguration(configurationModel.getObject(), task);

                            attributesModel.save(false);
                            TaskManagerBeans.get().getTaskUtil()
                                    .updateDomains(configurationModel.getObject(), domains);
    ...
    protected GeoServerTablePanel<Task> tasksPanel() {
        return new GeoServerTablePanel<Task>("tasksPanel", new TasksModel(configurationModel),
                true) {
                    ...
                    return new SimpleAjaxSubmitLink(id, new IModel<String>() {
                        ...
                        public String getObject() {
                            ...
                            if (sb.length() > 2) {
                                ...
                                return new ParamResourceModel("specifyParameters", getPage())
                                        .getString();
                            }
                        }
                    }) {
                ...
                if (property.equals(AttributesModel.VALUE)) {
                    ...
                    if (domain == null) {
                        ...
                        final DropDownPanel ddp = new DropDownPanel(id,
                                (IModel<String>) property.getModel(itemModel),
                                new PropertyModel<List<String>>(domains,
                        ...
                        ddp.getDropDownChoice().add(new AjaxFormSubmitBehavior("change") {
                            ...
                            protected void onSubmit(AjaxRequestTarget target) {
                                attributesModel.save(false);
                                TaskManagerBeans.get().getTaskUtil()
                                        .updateDependentDomains(itemModel.getObject(), domains);
            ...
            public void onSubmit(AjaxRequestTarget target, Form<?> form) {
                ...
                try {
                    configurationModel.setObject(TaskManagerBeans.get().getDataUtil().saveAndRemove(
                            configurationModel.getObject(), removedTasks,
                    ...
                    if (doReturn) {
                        ...
                        ((MarkupContainer) batchesPanel
                                .get("form:batchesPanel:listContainer:items")).removeAll();
                        target.add(feedbackPanel);
                    }
                } catch (Exception e) {
