...
public class FrequencyPanel extends Panel implements IFormModelUpdateListener {
                ...
                if (matcher.matches()) {
                    ...
                    if (matcher.matches()) {
                        ...
                        if (minutes <= 60 && hour < 24 && day > 0 && day <= 28) {
                            ...
                            timeModel.setObject(String.format("%02d", hour) + ":"
    ...
    public void onInitialize() {
        ...
        add(new DropDownChoice<DayOfWeek>("dayOfWeek", dayOfWeekModel,
                Arrays.asList(DayOfWeek.values()), new EnumChoiceRenderer<DayOfWeek>() {
            ...
            public void validate(IValidatable<String> validatable) {
                if (findParent(Form.class).findSubmittingButton() != null) {
                    ...
                    if (!(matcher.matches() && Integer.parseInt(matcher.group(1)) < 24
                        ...
                        error(new ParamResourceModel("timeFormatError", FrequencyPanel.this)
                                .getString());
                    }
                }
            }
    ...
    public void updateModel() {
        if (findParent(Form.class).findSubmittingButton() != null
                && typeModel.getObject() != Type.CUSTOM && timeModel.getObject() != null) {
                ...
                if (matcher.matches()) {
                    ...
                    if (typeModel.getObject() == Type.DAILY) {
                        ...
                        ((IModel<String>) getDefaultModel()).setObject(
                                "0 " + minute + " " + hour + " ? * " + dayOfWeekModel.getObject()
