...
public class BatchJobConcurrencyTest extends AbstractTaskManagerTest {
    ...
    public void setupBatch() {
        ...
        util.setTaskParameterToAttribute(task1, TestTaskTypeImpl.PARAM_DELAY_COMMIT,
                ATT_DELAY1_COMMIT);
    ...
    public void testConcurrency() throws InterruptedException, SchedulerException {
        ...
        Trigger trigger1 = TriggerBuilder.newTrigger().forJob(batch1.getFullName()).startNow()
                .build();
        scheduler.scheduleJob(trigger1);
        Trigger trigger2 = TriggerBuilder.newTrigger().forJob(batch2.getFullName()).startNow()
                .build();
