...
public abstract class Dimension {
    ...
    /**
     * Helper method that can be used by vectors types to create a filter with the current
     * restrictions.
     */
    ...
    /**
     * Helper method that can be used by raster types to create a filter with the current
     * restrictions.
     */
     ...
     */
    private Filter appendBoundingBoxFilter(Filter filter, CoverageInfo typeInfo)
            throws IOException {
     ...
     */
    private Filter appendDomainRestrictionsFilter(
    ...
    Tuple<ReferencedEnvelope, List<Object>> getRasterDomainValues(
            Filter filter,
