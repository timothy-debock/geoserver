...
public class SystemTestData extends CiteTestData {
    ...
    protected void createCatalog() throws IOException {
        ...
        catalog.addListener(new GeoServerConfigPersister(catalog.getResourceLoader(), 
    ...
    protected void createConfig() {
        ...
        geoServer.addListener(new GeoServerConfigPersister(new GeoServerResourceLoader(data), 
            createXStreamPersister()));
        catalog.addListener(new GeoServerResourcePersister(catalog.getResourceLoader()));
